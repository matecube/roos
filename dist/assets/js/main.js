(function() {
  ...
  function initMenu() {
    ...
    const leftContent = leftPanel == null ? void 0 : leftPanel.querySelector(".menu-content");
    const rightContent = rightPanel == null ? void 0 : rightPanel.querySelector(".menu-content");
    let previousWidth = window.innerWidth;
    let isLocked = false;
    const openMenu = () => {
    ...
    const closeMenu = () => {
      ...
      rightPanel == null ? void 0 : rightPanel.classList.remove("_visible");
      if (isLocked) {
        clearAllBodyScrollLocks();
        isLocked = false;
      }
    ...
    backBtn == null ? void 0 : backBtn.addEventListener("click", hideSubmenu);
  ...
  function initCategoryDrop() {
    ...
    containers.forEach((container) => {
      ...
      const dropIn = drop == null ? void 0 : drop.querySelector(".h-cat-drop-in");
      ...
      const handleDropdownOpen = () => {
        ...
        if (dropdownBottom > viewportHeight) {
          const dropPadding = parseFloat(getComputedStyle(drop).paddingTop || 0) + parseFloat(getComputedStyle(drop).paddingBottom || 0);
