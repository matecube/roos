...
function initCardCarousel() {
  const $carouselWrap = $(".cd-carousel");
  ...
  $carouselWrap.each(function () {
    ...
    // Read data-cols, fallback to 4 as default
    const dataCols = parseInt($this.data("cols"), 10) || 4;

    // Compute initial slide only for carousels with > 4 slides
    ...
    // Dynamically assign breakpoints per data-cols
    if (dataCols === 2) {
      ...
      // Default logic for 4-col carousel (and other, fallback to 4)
      swiperOptions.breakpoints = {
        0: {
          slidesPerView: 1.25,
          spaceBetween: 24,
